...
public class SampleQueue implements TrackOutput {
    ...
    private void onFormatResult(Format format, FormatHolder formatHolder) {
        ...
        if (z || !Util.areEqual(drmInitData, drmInitData2)) {
            ...
            if (drmInitData2 != null) {
                acquirePlaceholderSession = this.drmSessionManager.acquireSession(looper, drmInitData2);
            } else {
                acquirePlaceholderSession = this.drmSessionManager.acquirePlaceholderSession(looper, MimeTypes.getTrackType(format.sampleMimeType));
            }
    ...
    private boolean mayReadSample(int i) {
        ...
        return (this.flags[i] & C.BUFFER_FLAG_ENCRYPTED) == 0 && this.currentDrmSession.playClearSamplesWithoutKeys();
    }
