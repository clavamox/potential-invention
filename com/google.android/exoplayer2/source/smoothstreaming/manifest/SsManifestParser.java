...
public class SsManifestParser implements ParsingLoadable.Parser<SsManifest> {
    ...
    private static class QualityLevelParser extends ElementParser {
        ...
        public void parseStartTag(XmlPullParser xmlPullParser) throws ParserException {
            ...
            if (intValue == 2) {
                this.format = Format.createVideoContainerFormat(attributeValue, str, MimeTypes.VIDEO_MP4, fourCCToMimeType, null, null, parseRequiredInt, parseRequiredInt(xmlPullParser, KEY_MAX_WIDTH), parseRequiredInt(xmlPullParser, KEY_MAX_HEIGHT), -1.0f, buildCodecSpecificData(xmlPullParser.getAttributeValue(null, KEY_CODEC_PRIVATE_DATA)), 0, 0);
                return;
            }
            if (intValue != 1) {
                if (intValue == 3) {
                    ...
                    str2.hashCode();
                    this.format = Format.createTextContainerFormat(attributeValue, str, MimeTypes.APPLICATION_MP4, fourCCToMimeType, null, parseRequiredInt, 0, !str2.equals("CAPT") ? !str2.equals("DESC") ? 0 : 1024 : 64, (String) getNormalizedAttribute(KEY_LANGUAGE));
                    return;
                }
            ...
            this.format = Format.createAudioContainerFormat(attributeValue, str, MimeTypes.AUDIO_MP4, fourCCToMimeType, null, null, parseRequiredInt, parseRequiredInt2, parseRequiredInt3, buildCodecSpecificData, 0, 0, (String) getNormalizedAttribute(KEY_LANGUAGE));
        }
