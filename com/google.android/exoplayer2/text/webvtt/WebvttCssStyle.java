...
public final class WebvttCssStyle {
    ...
    public int getSpecificityScore(String str, String str2, String[] strArr, String str3) {
        ...
        int updateScoreForMatch = updateScoreForMatch(updateScoreForMatch(updateScoreForMatch(0, this.targetId, str, C.BUFFER_FLAG_ENCRYPTED), this.targetTag, str2, 2), this.targetVoice, str3, 4);
