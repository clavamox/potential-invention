...
public final class DefaultAudioSink implements AudioSink {
    ...
    public void configure(int i, int i2, int i3, int i4, int[] iArr, int i5, int i6) throws AudioSink.ConfigurationException {
        ...
        int channelConfig = getChannelConfig(i8, isEncodingLinearPcm);
        if (channelConfig == 0) {
            throw new AudioSink.ConfigurationException("Unsupported channel count: " + i8);
        }
        Configuration configuration = new Configuration(isEncodingLinearPcm, isEncodingLinearPcm ? Util.getPcmFrameSize(i, i2) : -1, i3, isEncodingLinearPcm ? Util.getPcmFrameSize(i7, i8) : -1, i9, channelConfig, i7, i4, z, z && !z2, audioProcessorArr);
        if (isInitialized()) {
    ...
    */
    ...
    public long getSubmittedFrames() {
        return this.configuration.isInputPcm ? this.submittedPcmBytes / this.configuration.inputPcmFrameSize : this.submittedEncodedFrames;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public long getWrittenFrames() {
        return this.configuration.isInputPcm ? this.writtenPcmBytes / this.configuration.outputPcmFrameSize : this.writtenEncodedFrames;
    }
    ...
    private static final class Configuration {
        ...
        private AudioTrack createAudioTrackV21(boolean z, AudioAttributes audioAttributes, int i) {
            ...
            return new AudioTrack(audioAttributes2, build, i2, 1, i);
        }
