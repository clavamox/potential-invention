...
public final class WavExtractor implements Extractor {
    ...
    private static final class PassthroughOutputWriter implements OutputWriter {
        ...
        public PassthroughOutputWriter(ExtractorOutput extractorOutput, TrackOutput trackOutput, WavHeader wavHeader, String str, int i) throws ParserException {
            ...
            this.format = Format.createAudioSampleFormat(null, str, null, wavHeader.frameRateHz * i2 * 8, max, wavHeader.numChannels, wavHeader.frameRateHz, i, null, null, 0, null);
        }
        ...
        */
        public boolean sampleData(com.google.android.exoplayer2.extractor.ExtractorInput r13, long r14) throws java.io.IOException, java.lang.InterruptedException {
            /*
                r12 = this;
                r0 = 0
    ...
    private static final class ImaAdPcmOutputWriter implements OutputWriter {
        ...
        public ImaAdPcmOutputWriter(ExtractorOutput extractorOutput, TrackOutput trackOutput, WavHeader wavHeader) throws ParserException {
            ...
            this.format = Format.createAudioSampleFormat(null, MimeTypes.AUDIO_RAW, null, ((wavHeader.frameRateHz * wavHeader.blockSize) * 8) / readLittleEndianUnsignedShort, numOutputFramesToBytes(max, i), wavHeader.numChannels, wavHeader.frameRateHz, 2, null, null, 0, null);
        }
