...
public final class DefaultDownloadIndex implements WritableDownloadIndex {
    ...
    private static final String[] COLUMNS = {"id", COLUMN_TYPE, COLUMN_URI, COLUMN_STREAM_KEYS, COLUMN_CUSTOM_CACHE_KEY, "data", COLUMN_STATE, COLUMN_START_TIME_MS, COLUMN_UPDATE_TIME_MS, COLUMN_CONTENT_LENGTH, "stop_reason", COLUMN_FAILURE_REASON, COLUMN_PERCENT_DOWNLOADED, COLUMN_BYTES_DOWNLOADED};
    ...
    public void putDownload(Download download) throws DatabaseIOException {
        ...
        contentValues.put(COLUMN_TYPE, download.request.type);
