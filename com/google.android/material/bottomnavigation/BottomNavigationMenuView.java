...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(this.itemHeight, C.BUFFER_FLAG_ENCRYPTED);
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (childAt2.getVisibility() != 8) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec(this.tempChildWidths[i12], C.BUFFER_FLAG_ENCRYPTED), makeMeasureSpec);
                childAt2.getLayoutParams().width = childAt2.getMeasuredWidth();
                i11 += childAt2.getMeasuredWidth();
            }
        }
        setMeasuredDimension(View.resolveSizeAndState(i11, View.MeasureSpec.makeMeasureSpec(i11, C.BUFFER_FLAG_ENCRYPTED), 0), View.resolveSizeAndState(this.itemHeight, makeMeasureSpec, 0));
    }
