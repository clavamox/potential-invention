    ...
    public void onClick(View view) {
        if (this.viewList.size() == 2) {
            ...
            if (this.listener != null) {
                ...
                this.listener.setOnSegment(view, view.getId());
            }
            ...
            if (((Integer) view.getTag()).intValue() == 2) {
                ...
                OnSegmentListener onSegmentListener = this.listener;
                if (onSegmentListener != null) {
                    onSegmentListener.onMirrorState(view.isSelected());
                }
            } else {
                for (TextView textView3 : this.viewList) {
                    textView3.setSelected(false);
                    setTextColorVal(textView3);
                }
                if (this.listener != null) {
                    TextView textView4 = (TextView) view;
                    textView4.setSelected(true);
                    setSelectedTextColor(textView4);
                    this.listener.setOnSegment(view, view.getId());
                }
            }
        }
