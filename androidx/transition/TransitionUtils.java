...
class TransitionUtils {
    ...
    static View copyViewImage(ViewGroup viewGroup, View view, View view2) {
        ...
        imageView.measure(View.MeasureSpec.makeMeasureSpec(round3 - round, C.BUFFER_FLAG_ENCRYPTED), View.MeasureSpec.makeMeasureSpec(round4 - round2, C.BUFFER_FLAG_ENCRYPTED));
