        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    ...
                    makeMeasureSpec3 = View.MeasureSpec.makeMeasureSpec(paddingLeft - i9, C.BUFFER_FLAG_ENCRYPTED);
                } else {
                    makeMeasureSpec3 = View.MeasureSpec.makeMeasureSpec(layoutParams.width, C.BUFFER_FLAG_ENCRYPTED);
                }
                if (layoutParams.height == -2) {
                    makeMeasureSpec4 = View.MeasureSpec.makeMeasureSpec(paddingTop, Integer.MIN_VALUE);
                } else if (layoutParams.height == -1) {
                    makeMeasureSpec4 = View.MeasureSpec.makeMeasureSpec(paddingTop, C.BUFFER_FLAG_ENCRYPTED);
                } else {
                    makeMeasureSpec4 = View.MeasureSpec.makeMeasureSpec(layoutParams.height, C.BUFFER_FLAG_ENCRYPTED);
                }
                        ...
                        if (!z2 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                if (layoutParams2.width == 0) {
                                    if (layoutParams2.height == -2) {
                                        ...
                                        makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(paddingTop, C.BUFFER_FLAG_ENCRYPTED);
                                    } else {
                                        makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(layoutParams2.height, C.BUFFER_FLAG_ENCRYPTED);
                                    }
                                } else {
                                    makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), C.BUFFER_FLAG_ENCRYPTED);
                                }
                                if (z2) {
                                    int i12 = paddingLeft - (layoutParams2.leftMargin + layoutParams2.rightMargin);
                                    i5 = i10;
                                    int makeMeasureSpec5 = View.MeasureSpec.makeMeasureSpec(i12, C.BUFFER_FLAG_ENCRYPTED);
                                    ...
                                    i5 = i10;
                                    childAt2.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth2 + ((int) ((layoutParams2.weight * Math.max(0, i8)) / f)), C.BUFFER_FLAG_ENCRYPTED), makeMeasureSpec);
                                    i11++;
                                    i10 = i5;
                                    i4 = 8;
                                }
                            ...
                            if (z4) {
                                if (layoutParams2.height == -2) {
                                    ...
                                    i6 = C.BUFFER_FLAG_ENCRYPTED;
                                } else if (layoutParams2.height == -1) {
                                    i6 = C.BUFFER_FLAG_ENCRYPTED;
                                    makeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(paddingTop, C.BUFFER_FLAG_ENCRYPTED);
                                } else {
                                    i6 = C.BUFFER_FLAG_ENCRYPTED;
                                    makeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(layoutParams2.height, C.BUFFER_FLAG_ENCRYPTED);
                                }
                            } else {
                                i6 = C.BUFFER_FLAG_ENCRYPTED;
                                makeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), C.BUFFER_FLAG_ENCRYPTED);
                            }
