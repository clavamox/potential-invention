...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    public void onMeasure(int i, int i2) {
        ...
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(this.mContentHeight, C.BUFFER_FLAG_ENCRYPTED);
    ...
    private class TabView extends LinearLayout {
        ...
        public void onMeasure(int i, int i2) {
            ...
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(ScrollingTabContainerView.this.mMaxTabWidth, C.BUFFER_FLAG_ENCRYPTED), i2);
        }
