...
public class ViewPager extends ViewGroup {
    ...
    */
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (true) {
            boolean z2 = true;
            int i8 = C.BUFFER_FLAG_ENCRYPTED;
            if (i7 >= childCount) {
                break;
            }
        ...
        this.mChildWidthMeasureSpec = View.MeasureSpec.makeMeasureSpec(paddingLeft, C.BUFFER_FLAG_ENCRYPTED);
        this.mChildHeightMeasureSpec = View.MeasureSpec.makeMeasureSpec(measuredHeight, C.BUFFER_FLAG_ENCRYPTED);
        this.mInLayout = true;
        populate();
        ...
        for (int i12 = 0; i12 < childCount2; i12++) {
            ...
            if (childAt2.getVisibility() != 8 && ((layoutParams = (LayoutParams) childAt2.getLayoutParams()) == null || !layoutParams.isDecor)) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (paddingLeft * layoutParams.widthFactor), C.BUFFER_FLAG_ENCRYPTED), this.mChildHeightMeasureSpec);
            }
        }
    }
